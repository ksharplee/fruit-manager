<template>
  <div>
    <div
      ref="editorToolbar"
      style="text-align:left;background-color:#eee;border:1px solid #ccc;margin-bottom:-1px"
    />
    <div
      ref="editorArea"
      :style="`text-align:left;border:1px solid #ccc;height:${height}px;`"
    />
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    editor.customConfig.uploadImgServer = `${process.env.VUE_APP_API}/g/upload_multiple_image.html`;
